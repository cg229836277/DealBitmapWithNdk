...
extern "C"
    {
//store
    JNIEXPORT jobject JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniStoreBitmapData(
	    JNIEnv * env, jobject obj, jobject bitmap);
//get
    JNIEXPORT jobject JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniGetBitmapFromStoredBitmapData(
	    JNIEnv * env, jobject obj, jobject handle);
//free
    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniFreeBitmapData(
	    JNIEnv * env, jobject obj, jobject handle);
//rotate 90 degrees CCW
    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniRotateBitmapCcw90(
	    JNIEnv * env, jobject obj, jobject handle);
//rotate 90 degrees CW
    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniRotateBitmapCw90(
	    JNIEnv * env, jobject obj, jobject handle);
//rotate 180 degrees
    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniRotateBitmap180(
	    JNIEnv * env, jobject obj, jobject handle);
//crop
    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniCropBitmap(
	    JNIEnv * env, jobject obj, jobject handle, uint32_t left,
	    uint32_t top, uint32_t right, uint32_t bottom);
//scale using nearest neighbor
    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniScaleNNBitmap(
	    JNIEnv * env, jobject obj, jobject handle, uint32_t newWidth,
	    uint32_t newHeight);

//scale using Bilinear Interpolation
    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniScaleBIBitmap(
	    JNIEnv * env, jobject obj, jobject handle, uint32_t newWidth,
	    uint32_t newHeight);

    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniFlipBitmapHorizontal(
	    JNIEnv * env, jobject obj, jobject handle);

    JNIEXPORT void JNICALL Java_com_jni_bitmap_operations_JniBitmapHolder_jniFlipBitmapVertical(
	    JNIEnv * env, jobject obj, jobject handle);
    }
